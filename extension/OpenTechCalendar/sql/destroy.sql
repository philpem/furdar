...
DROP TABLE IF EXISTS group_in_legacy_location CASCADE;
DROP TABLE IF EXISTS legacy_location_information CASCADE;
DROP TABLE IF EXISTS legacy_region_information CASCADE;

...
class CuratedListGroupTest extends \BaseAppWithDBTest
{
    ...
    public function testEventInTwoGroupsOneAdded()
    {
        TimeSource::mock(2014, 5, 1, 7, 0, 0);
    ...
    public function testEventInTwoGroupsBothAdded()
    {
        TimeSource::mock(2014, 5, 1, 7, 0, 0);
    ...
    public function testEventInTwoGroupsAddedDirectlyThenOneGroupAdded()
    {
        TimeSource::mock(2014, 5, 1, 7, 0, 0);

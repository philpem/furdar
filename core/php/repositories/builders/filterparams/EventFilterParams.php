...
{
    public function __construct(Application $app, EventRepositoryBuilder $erb = null, SiteModel $siteModel = null)
    {
        $this->app = $app;
        if ($erb) {
    ...
    public function set($data)
    {
        if (isset($data['eventListFilterDataSubmitted'])) {
            ...
            if ($this->hasSpecifiedUserControls) {
                ...
                } elseif (isset($data['specifiedUserWhich']) && $data['specifiedUserWhich'] == "A") {
                    $this->includeSpecifiedUserAttending = true;
        ...
        if ($this->hasSpecifiedUserControls) {
            $this->eventRepositoryBuilder->setUserAccount(
                $this->hasSpecifiedUser,
                false,
                $this->hasSpecifiedUserIncludePrivate,
                $this->includeSpecifiedUserAttending,
                $this->includeSpecifiedUserWatching
            );
        }

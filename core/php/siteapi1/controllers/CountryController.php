...
class CountryController
{
    ...
    public function eventsIcal($slug, Request $request, Application $app)
    {
    ...
    public function eventsJson($slug, Request $request, Application $app)
    {
    ...
    public function eventsJsonp($slug, Request $request, Application $app)
    {
        $ourRequest = new \Request($request);
    ...
    public function eventsCSV($slug, Request $request, Application $app)
    {
        $ourRequest = new \Request($request);
    ...
    public function eventsAtomBefore($slug, Request $request, Application $app)
    {
        if (!$this->build($slug, $request, $app)) {
            $app->abort(404, "Country does not exist.");
        }
    ...
    public function eventsAtomCreate($slug, Request $request, Application $app)
    {
        if (!$this->build($slug, $request, $app)) {
            $app->abort(404, "Country does not exist.");
        }
    ...
    public function areasJson($slug, Request $request, Application $app)
    {
        if (!$this->build($slug, $request, $app)) {
            $app->abort(404, "Country does not exist.");
        }

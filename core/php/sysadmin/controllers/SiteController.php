...
class SiteController
{
    ...
    public function show($id, Request $request, Application $app)
    {
        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                } elseif ($action->getCommand() == 'newslug') {
    ...
    public function watchers($id, Request $request, Application $app)
    {
        $this->build($id, $request, $app);
    ...
    public function features($id, Request $request, Application $app)
    {
        $this->build($id, $request, $app);
    ...
    public function listCountries($siteid, Request $request, Application $app)
    {
    ...
    public function showCountry($siteid, $countrycode, Request $request, Application $app)
    {
        $this->build($siteid, $request, $app);
    ...
    public function listUsersNotEditors($siteid, Request $request, Application $app)
    {
        $this->build($siteid, $request, $app);

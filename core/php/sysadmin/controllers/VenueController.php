        ...
        if ('POST' == $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                if ($action->getCommand() == 'delete' && !$this->parameters['venue']->getIsDeleted()) {
                    ...
                    $redirect = true;
                } elseif ($action->getCommand() == 'undelete' && $this->parameters['venue']->getIsDeleted()) {
                    ...
                    $redirect = true;
                } elseif ($action->getCommand() == 'purge' && $app['config']->sysAdminExtraPurgeVenuePassword && $app['config']->sysAdminExtraPurgeVenuePassword == $action->getParam(0)) {
                    $vr = new VenueRepository($app);

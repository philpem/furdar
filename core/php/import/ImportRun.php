...
class ImportRun
{
    ...
    public function __construct(Application $app, ImportModel $import, SiteModel $site = null)
    {
        $this->app = $app;
        $this->import = $import;
    ...
    {
        if ($this->temporaryFileStorageFromTesting) {
            return $this->temporaryFileStorageFromTesting;
        }
    ...
    public function markImportedEventSeen(ImportedEventModel $importedEventModel)
    {
        $this->importedEventsSeenIds[$importedEventModel->getId()] = true;
    }

    public function wasImportedEventSeen(ImportedEventModel $importedEventModel)
    {

...
class EventHistoryModel extends EventModel implements \InterfaceHistoryModel
{
    ...
    public function setFromDataBaseRow($data)
    {
        ...
        } elseif ($data['custom_fields_changed'] == "[]") {
            $this->custom_fields_changed = -1;
        } elseif (is_int($data['custom_fields_changed']) && $data['custom_fields_changed'] == 0) {
            $this->custom_fields_changed = 0;
        } elseif ((is_int($data['custom_fields_changed']) && $data['custom_fields_changed'] == -2) || $data['custom_fields_changed'] == "-2") {
            $this->custom_fields_changed = -2;
        } elseif ($data['custom_fields_changed'] && $data['custom_fields_changed'] != '[]') {
    ...
    public function setChangedFlagsFromLast(EventHistoryModel $last)
    {
        ...
        if ($this->custom_fields_changed == 0  && $last->custom_fields_changed != -2) {
            ...
            foreach (array_keys($this->custom_fields) as $k) {
                ...
                } elseif (array_key_exists($k, $this->custom_fields)) {
                    $this->custom_fields_changed[$k] = $this->custom_fields[$k] ? 1 : -1;
                } else {
    ...
    public function getCustomFieldChanged(EventCustomFieldDefinitionModel $customField)
    {
        if ($this->custom_fields_changed == -2) {
            return false;
        } elseif (isset($this->custom_fields_changed[$customField->getId()])) {

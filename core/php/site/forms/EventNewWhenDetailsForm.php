...
class EventNewWhenDetailsForm extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        } elseif ($options['newEventDraftModel']->hasDetailsValue('event.start_end_freetext.start')) {
            $data = $options['newEventDraftModel']->getDetailsValueAsDateTime('event.start_end_freetext.start');
        } elseif ($options['newEventDraftModel']->hasDetailsValue('incoming.event.start_at')) {
        ...
        } elseif ($options['newEventDraftModel']->hasDetailsValue('event.start_end_freetext.end')) {
            $data = $options['newEventDraftModel']->getDetailsValueAsDateTime('event.start_end_freetext.end');
        } elseif ($options['newEventDraftModel']->hasDetailsValue('incoming.event.end_at')) {

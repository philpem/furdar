...
class ImportController
{
    ...
    public function log($slug, Request $request, Application $app)
    {
        if (!$this->build($slug, $request, $app)) {
            $app->abort(404, "Import does not exist.");
        }
    ...
    public function enable($slug, Request $request, Application $app)
    {
        if (!$this->build($slug, $request, $app)) {
            $app->abort(404, "Import does not exist.");
        }
    ...
    public function disable($slug, Request $request, Application $app)
    {
        if (!$this->build($slug, $request, $app)) {
            $app->abort(404, "Import does not exist.");
        }
    ...
    public function enableFromNotification($slug, $userid, $usercode, Request $request, Application $app)
    {
        // Check Import ......
        if (!$this->build($slug, $request, $app)) {
            $app->abort(404, "Import does not exist.");

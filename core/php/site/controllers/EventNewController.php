...
{
    public function getSteps(Request $request, Application $app, NewEventDraftModel $newEventDraftModel)
    {
        $out = array();
    ...
    public function newEvent(Request $request, Application $app)
    {
    ...
    public function newEventDraft($draftslug, $stepid, Request $request, Application $app)
    {
    ...
    public function newEventDraftJSON($draftslug, $stepid, Request $request, Application $app)
    {
        if (!$this->buildDraft($draftslug, $request, $app)) {
            return $app->abort(404);
        }
    ...
    public function newEventIsDupeOf($draftslug, $eventslug, Request $request, Application $app)
    {
        if (!$this->buildDraft($draftslug, $request, $app)) {
            return $app->abort(404);
        }

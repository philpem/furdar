...
class SendUserWatchesGroupPromptEmailsTask extends \BaseTask
{
    ...
    protected function run()
    {
        ...
        foreach ($b->fetchAll() as $userWatchesGroup) {
            ...
            } elseif ($group->getIsDeleted()) {
                $this->logVerbose(" ... group is deleted");
            } elseif ($userHasNoEditorPermissionsInSiteRepo->isUserInSite($user, $site)) {
                $this->logVerbose(" ... user does not have edit permissions allowed in site");
            } elseif (!$userPermissions->hasPermission("org.openacalendar", "CALENDAR_CHANGE")) {
            ...
            } elseif ($userWatchesGroup->getIsWatching()) {

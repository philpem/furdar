...
{
    public function dataForTestGetEventPatternData()
    {
        return array(
     ...
     */
    public function testGetEventPatternData($year, $month, $day, $weekOfmonth, $lastInMonth)
    {
     ...
     *
     */
    public function testNoTitleChange()
    {
     ...
     *
     */
    public function testLongTitleChange()
    {
        $this->app['timesource']->mock(2012, 7, 1, 7, 0, 0);
     ...
     *
     */
    public function testShortTitleChange()
    {
        $this->app['timesource']->mock(2012, 7, 1, 7, 0, 0);
    ...
    public function testFirstWeekInMonthAlsoFirstDayInMonth()
    {
    ...
    public function testFirstWeekInMonthButNotFirstDayInMonth()
    {
        $this->app['timesource']->mock(2012, 9, 20, 14, 27, 0);
    ...
    public function testFiveWeekInMonth()
    {
        $this->app['timesource']->mock(2012, 9, 20, 14, 27, 0);
    ...
    public function testFiveWeekInMonth2()
    {
     ...
     */
    public function testFourthMondayInMonth()
    {
    ...
    public function testDaysInAdvance1()
    {
    ...
    public function testDaysInAdvance2()
    {
     ...
     */
    public function testWeGetFutureEventsOnly1()
    {
        $this->app['timesource']->mock(2012, 7, 1, 7, 0, 0);
     ...
     * This test makes sure we are offered events in the future from now only!
     **/
    public function testWeGetFutureEventsOnly2()
    {

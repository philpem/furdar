...
class EventRecurSetModelProposedChangesTest extends \BaseAppTest
{
    ...
    /*
     */
    public function testChangeDescription1()
    {
    ...
    public function dataForTestChangeSummary1()
    {
        return array(
     ...
     */
    public function testChangeSummary1($janMonthName, $febMonthName, $marMonthName, $aprMonthName)
    {
        $this->app['timesource']->mock(2014, 1, 1, 9, 0, 0);
    ...
    public function testChangeStartEnd1()
    {
        $this->app['timesource']->mock(2014, 1, 1, 9, 0, 0);

...
class SiteRepositoryBuilderUserInterestedInTest extends \BaseAppWithDBTest
{
    ...
    public function testUserWatchesSite()
    {
        $user = new UserAccountModel();
        $user->setEmail("test@jarofgreen.co.uk");
        $user->setUsername("test");
    ...
    public function testUserWatchesGroup()
    {
        $user = new UserAccountModel();
        $user->setEmail("test@jarofgreen.co.uk");
        $user->setUsername("test");
    ...
    public function testUserWatchesArea()
    {
    ...
    public function testUserIsUserGroup()
    {
        $user = new UserAccountModel();
        $user->setEmail("test@jarofgreen.co.uk");
        $user->setUsername("test");
    ...
    public function testUserIsInterestedInSite()
    {
        $user = new UserAccountModel();
        $user->setEmail("test@jarofgreen.co.uk");
        $user->setUsername("test");
